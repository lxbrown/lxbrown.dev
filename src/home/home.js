...
export default function Home() {
    return (
        <FadeIn className="home" childClassName='homeElement'>
            ...
            at <b><a className='homeLink' href='https://www.intersystems.com/' target='_blank' rel='noreferrer'>InterSystems</a></b>.
            I'm also a rower, (newly) biker, and (not so newly) gamer.
